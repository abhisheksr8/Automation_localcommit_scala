...
import io.prophecy.pipelines.automation_localcommit_scala_pipeline.udfs.UDFs._
import io.prophecy.pipelines.automation_localcommit_scala_pipeline.udfs.PipelineInitCode._
...
object Main {
  ...
  def apply(context: Context): Unit = {
    ...
    val df_config_column_reformatting =
      config_column_reformatting(context, df_test_dataset)
  }
